            ...
            <div class="swiper-slide h-96">
                ...
                <div class="absolute z-20 bottom-5 p-4 text-left w-full">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('news.show',$item) }}" class="text-white underline text-sm">Толығырақ</a>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 sm:-m-4 -mx-4 -mb-10 pb-8">
                ...
                <div class="p-4 sm:mb-0 mb-6">
                    ...
                    <a class="text-indigo-400 inline-flex items-center mt-3" href="{{ route('announcement.show', $item) }}">Толығырақ
